...
export const exercises: Record<string, Exercise> = {
  ...
  overheadTri: { id:'overheadTri', name:'Overhead Triceps Extension', muscles:'Triceps', sets:'2 × 10–12', rest:'60 sec', equipment:'Dumbbell / cable', cue:'Keep ribs down and elbows pointing forward. Lower behind your head to a comfortable stretch, then extend fully.', gif:'/exercises/overhead-triceps.gif' },
